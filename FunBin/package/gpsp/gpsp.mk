...
define GPSP_CREATE_OPK
	...
	$(HOST_DIR)/usr/bin/mksquashfs $(GPSP_PKGDIR)/opk/gba $(TARGET_DIR)/usr/local/share/OPKs/Emulators/gba_gpsp_funboy-40a.opk -all-root -noappend -no-exports -no-xattrs
endef
