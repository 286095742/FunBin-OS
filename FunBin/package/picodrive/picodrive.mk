...
define PICODRIVE_CREATE_OPK
	...
	$(HOST_DIR)/usr/bin/mksquashfs $(PICODRIVE_PKGDIR)/opk/megadrive $(TARGET_DIR)/usr/local/share/OPKs/Emulators/megadrive_picodrive_funboy-40a.opk -all-root -noappend -no-exports -no-xattrs
	$(HOST_DIR)/usr/bin/mksquashfs $(PICODRIVE_PKGDIR)/opk/sms $(TARGET_DIR)/usr/local/share/OPKs/Emulators/sms_picodrive_funboy-40a.opk -all-root -noappend -no-exports -no-xattrs
endef
