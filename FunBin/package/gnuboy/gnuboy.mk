...
GNUBOY_VERSION = gnuboy-FunBin-1.2.2
...
define GNUBOY_CREATE_OPK
	...
	$(HOST_DIR)/usr/bin/mksquashfs $(GNUBOY_PKGDIR)/opk/gb $(TARGET_DIR)/usr/local/share/OPKs/Emulators/gb_gnuboy_funboy-40a.opk -all-root -noappend -no-exports -no-xattrs
	$(HOST_DIR)/usr/bin/mksquashfs $(GNUBOY_PKGDIR)/opk/gbc $(TARGET_DIR)/usr/local/share/OPKs/Emulators/gbc_gnuboy_funboy-40a.opk -all-root -noappend -no-exports -no-xattrs
endef
